...
# from src.agents.sentiment_agent import SentimentAgent  # Disabled - has many dependencies
...
def run_agents():
    ...
    try:
        ...
        # sentiment_agent = SentimentAgent() if ACTIVE_AGENTS['sentiment'] else None  # Disabled
        sentiment_agent = None  # Disabled - has many dependencies
